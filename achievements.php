...
<title>Achievement | MY GOV Hospitals</title>
...
<div id="slider">
	...
	<div id="templatemo_main">
		...
		<div id="aboutUs">
		<?php
			$doctorID=trim($_GET["dID"]);
			$dName=$_GET['dName'];
			echo '<h1>'.$dName.'-Achievement List</h1>';
			session_start();
			...
			$sql1 = "SELECT description FROM achievement WHERE doctorID='".$doctorID."'";
			...
			$aNum = count($achievements);
			if($aNum==0)
				 echo "<p><i>No achievements to show.</i><p>";
			else
			{
				echo '<table border="1">';
				echo '<tr>
				...
				for($i=0;$i<$aNum;$i++)
				{						
					echo "<tr><td>".$sno."</td><td>".$achievements[$i]."</td>";
					$sno++;
				}
				echo '</table>';				
			}
		...
		<div id="templatemo_footer">
			Copyright © 2017 <a href="index.php">MYGovHospital</a> | <a href="#content" target="_parent">Achievement | MY Gov Hospital</a> by <a href="index.php" target="_parent">MY GOV Hospital</a>
        </div> <!-- end of footer -->
    </div> <!-- end of main -->
</div>
</body>
